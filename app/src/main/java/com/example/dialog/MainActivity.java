...
public class MainActivity extends AppCompatActivity {
    ...
    public void charactordialog(View v){
        final String options="12121212121";
        Dialog cpd=new CharacterPickerDialog(this,new View(this),null,options,false){
            @Override
    ...
    public void progressdialog(View v){
        final ProgressDialog pg=ProgressDialog.show(this,"加载","加载中，请稍等！",true);
        new Thread(){
            public void run() {
                try{
                    sleep(2000);
